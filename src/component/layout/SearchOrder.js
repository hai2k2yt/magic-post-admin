        ...
        <div id="searchOrder" class="hero min-h-screen bg-base-200">
            <div class="hero-content flex-col lg:flex-row">
                ...
                <div>
                    ...
                    <p class="py-6">Nhập mã phiếu gửi, tra cứu nhiều đơn hàng bằng cách đặt dấu phẩy giữa mỗi mã vận đơn.</p>
                    <div class="join">
                        <input id="orderCode" class="input input-bordered join-item" placeholder="Mã phiếu gửi" />
                        <button class="btn btn-primary join-item">Tra cứu</button>
                    </div>
                </div>
            </div>
        </div>
