...
import { getOrder, trackingOrder } from "../api/order";
    ...
    return (
        <ThemeProvider theme={theme}>
            <div style={{ minHeight: '80vh', }}>
                ...
                <Item> */}
                <div class='my-20 hero bg-base-200'>
                    <div class="hero-content flex-col lg:flex-row">
                        ...
                        <div>
                            <h1 class="text-5xl font-bold">Tra cứu vận đơn</h1>
                            <p class="py-6">Nhập mã phiếu gửi vào ô dưới đây và nhấp tra cứu để tìm kiếm thông tin đơn hàng.</p>
                            <div class="join">
                                <input value={orderId}
                                    onChange={e => setOrderId(e.target.value)}
                                    class="input input-bordered join-item"
                                    placeholder="Mã phiếu gửi" />
                                <button onClick={fetchOrderDetail} class="btn btn-primary join-item">Tra cứu</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <Box p={2}>
                        <Paper elevation={3}
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={6}>
                                    <Typography fontWeight={700}>Họ tên:</Typography> <Typography> {order?.sender?.name}</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                    <Typography fontWeight={700}>Điện thoại:</Typography> <Typography> {order?.sender?.phone}</Typography>
                                </Grid>
                                <Grid item xs={12}>
                            ...
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs={4}>
                                    <Typography fontWeight={700}>Địa chỉ:</Typography> <Typography> {order?.sender?.address?.street}</Typography>
                                </Grid>
                                <Grid item xs={4}>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={4}>
                                    <Typography fontWeight={700} style={{ marginBottom: '20px' }}>Người gửi</Typography>
                                    <Typography fontWeight={700}>Cước chính:</Typography> <Typography> {order?.price?.mainTax}</Typography>
                                    <Typography fontWeight={700}>Phụ phí:</Typography> <Typography> {order?.price?.subTax}</Typography>
                                    <Typography fontWeight={700}>Phí vận chuyển:</Typography> <Typography> {order?.price?.transportTax}</Typography>
                                    <Typography fontWeight={700}>Tổng phí:</Typography> <Typography> {order?.price?.totalTax}</Typography>
                            ...
                            <Grid container spacing={2}>
                                <Grid item xs={4}>
                                    <Typography fontWeight={700}>Khối lượng thực tế: </Typography> <Typography>{order?.actualWeight}</Typography>
                                </Grid>
                                <Grid item xs={4}>
                            ...
                            <TimelineItem>
                                ...
                                <TimelineContent>
                                    <Typography fontWeight={700} variant="body2">Thời gian 1</Typography>
                                    <Typography fontWeight={700} variant="body2" color="textSecondary">Message 1</Typography>
                                </TimelineContent>
                            </TimelineItem>
                            <TimelineItem>
                                <TimelineSeparator>
                                ...
                                <TimelineContent>
                                    <Typography fontWeight={700} variant="body2">Thời gian 2</Typography>
                                    <Typography fontWeight={700} variant="body2" color="textSecondary">Message 2</Typography>
                                </TimelineContent>
                            </TimelineItem>
